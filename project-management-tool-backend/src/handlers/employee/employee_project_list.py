...
#                 "assignee_id": task.assignee_id,
#                 "extra_days": (
#                          ((task.actual_end_date or current_date) - task.end_date).days 
...
class EmployeeProjectTaskHandler:
    ...
    def employeeProjectTaskCompletedList(self):
        try:
            ...
            #                 and_(
            #                     Task.assignee_id == assignee_id,
            #                     Task.status == "DONE",  # or "IN_PROGRESS" or "TODO"
            #                     Task.actual_end_date > Task.end_date
            #                 )
            #             )
    ...
    def employeeProjectTaskInprogressList(self):
        try:
            ...
            #                 and_(
            #                     Task.assignee_id == assignee_id,
            #                     Task.status == "IN_PROGRESS",  # or "IN_PROGRESS" or "TODO"
            #                     Task.actual_end_date > Task.end_date
            #                 )
            #             )
    ...
    def employeeProjectTaskToDoList(self):
        try:
            ...
            #                 and_(
            #                     Task.assignee_id == assignee_id,
            #                     Task.status == "TODO",  # or "IN_PROGRESS" or "TODO"
            #                     Task.actual_end_date > Task.end_date
            #                 )
            #             )
